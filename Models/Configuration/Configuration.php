...
final class Configuration implements ConfigurationInterface
{
    ...
    public function __construct(
        ...
        //      Row: active_plugins
        //      Value (in JSON): <..>;i:0;s:32:"Benefits/Benefits.php";<..>
        ...
        // 1. __FILE__ => /GitHub/<REPOSITORY_NAME>/wp-content/plugins/Benefits/Benefits.php
        // 2. plugin_dir_path(__FILE__) => /GitHub/<REPOSITORY_NAME>/wp-content/plugins/Benefits/ (with trailing slash at the end)
        // 3. plugin_basename(__FILE__) => Benefits/Benefits.php (used for active plugins list in WP database)
        // 4. dirname(plugin_basename((__FILE__)) => Benefits
        // 5. basename($this->pluginPath) => Benefits
        // 6. localLangRelPath used for load_textdomain, i.e. Benefits/Languages/ (the correct example is WITH the ending trailing slash)
        ...
        // Demo examples (__FILE__ = $this->pluginFolderAndFile):
        // 1. plugin_dir_url(__FILE__) => https://nativerental.com/wp-content/plugins/Benefits/
    ...
    /**
     * localLangRelPath used for load_textdomain (without slash at the end), i.e. Benefits/Languages
