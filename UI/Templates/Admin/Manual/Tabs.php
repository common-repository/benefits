...
?>
<div class="benefits-manual-admin benefits-tabbed-admin benefits-tabbed-admin-medium bg-cyan">
	<?php if ($errorMessage != ""): ?>
	...
	<div class="body">
		...
		<div class="modern-tabs modern-tabs-pos-top-left modern-tabs-anim-flip modern-tabs-response-to-icons">
            ...
            <input type="radio" name="modern-tabs"<?=(!empty($tabs['url-parameters']) ? ' checked="checked"' : '');?> id="modern-tab4" class="modern-tab-content-4">
            <label for="modern-tab4"><span><span><i class="fa fa-link" aria-hidden="true"></i><?=esc_html($lang['LANG_MANUAL_URL_PARAMETERS_TEXT']);?></span></span></label>
			...
			<ul>
                ...
                <li class="modern-tab-content-4">
                    <div class="typography">
                        <?php include 'Shared/URL_ParametersPartial.php'; ?>
                    </div>
                </li>
